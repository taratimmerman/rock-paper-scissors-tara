...
async function loadTSConfig(config, options) {
  ...
  let parsedConfig = _typescript().default.parseJsonConfigFileContent(configResult.contents, host, _path().default.dirname((0, _nullthrows().default)(configResult.filePath)));
