...
class Model {
    ...
    doesMoveBeat(a, b) {
        var _a, _b;
        return (_b = (_a = (0, _dataUtils.MOVE_DATA_MAP).get(a)) === null || _a === void 0 ? void 0 : _a.beats.includes(b)) !== null && _b !== void 0 ? _b : false;
    }
    ...
    getPlayerScoreFromStorage() {
        return this.getScoreFromStorage((0, _dataUtils.PARTICIPANTS).PLAYER);
    }
    getComputerScoreFromStorage() {
        return this.getScoreFromStorage((0, _dataUtils.PARTICIPANTS).COMPUTER);
    }
    getScore(key) {
    ...
    getPlayerMostCommonMoveFromStorage() {
        return this.getMostCommonMoveFromStorage((0, _dataUtils.PARTICIPANTS).PLAYER);
    }
    getComputerMostCommonMoveFromStorage() {
        return this.getMostCommonMoveFromStorage((0, _dataUtils.PARTICIPANTS).COMPUTER);
    }
    ...
    chooseComputerMove() {
        ...
        const moveMap = hasTara ? (0, _dataUtils.MOVE_DATA_MAP) : (0, _dataUtils.STANDARD_MOVE_DATA_MAP);
    ...
    setPlayerMostCommonMove() {
        ...
        this.setMostCommonMove((0, _dataUtils.PARTICIPANTS).PLAYER, moves);
    }
    setComputerMostCommonMove() {
        const moves = this.getComputerHistory();
        this.setMostCommonMove((0, _dataUtils.PARTICIPANTS).COMPUTER, moves);
    }
    ...
    getPlayerTaraCountFromStorage() {
        return this.getTaraCountFromStorage((0, _dataUtils.PARTICIPANTS).PLAYER);
    }
    getComputerTaraCountFromStorage() {
        return this.getTaraCountFromStorage((0, _dataUtils.PARTICIPANTS).COMPUTER);
    }
    ...
    getPlayerHistoryFromStorage() {
        return this.getHistoryFromStorage((0, _dataUtils.PARTICIPANTS).PLAYER);
    }
    getComputerHistoryFromStorage() {
        return this.getHistoryFromStorage((0, _dataUtils.PARTICIPANTS).COMPUTER);
    }
    getHistory(key) {
    ...
    setPlayerHistory(move) {
        this.setHistory((0, _dataUtils.PARTICIPANTS).PLAYER, move);
    }
    setComputerHistory(move) {
        this.setHistory((0, _dataUtils.PARTICIPANTS).COMPUTER, move);
    }
    resetHistories() {
    ...
    getPlayerHistory() {
        return this.getHistory((0, _dataUtils.PARTICIPANTS).PLAYER);
    }
    getComputerHistory() {
        return this.getHistory((0, _dataUtils.PARTICIPANTS).COMPUTER);
    }
}

},{"../utils/dataUtils":"hnBcW","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hnBcW":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"5hI6v":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
